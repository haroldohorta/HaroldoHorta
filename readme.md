<div align="center">
  ...
  <p>
    <i>"Desde la trinchera sandinista y el asedio en Lima, hasta el silencio de la Antártida y el vuelo libre en Atacama. Un legado que rechazó la comodidad para documentar la dignidad humana desde el cielo y la tierra."</i>
  </p>
...
* **`nomad_*`** → **Bitácora Nómada:** Registro libre en Motor Home por Sudamérica.
* **`fly_*`** → **Vuelo Aéreo:** Perspectiva cenital (Paramotor / Ultraligero).
* **`narra_*`** → **Narrativa Sonora:** Historias en voz viva *[En construcción]*.
